...
<body>
    ...
    <main>
        <div>
            ...
            jogos nos últimos anos. Eles envolvem equipes de jogadores competindo em batalhas estratégicas, combinando
            elementos de jogos de estratégia em tempo real e RPG. Aqui está uma visão geral da história, competitividade
...
<br>
            <p>O jogo "League of Legends" é um exemplo proeminente de um MOBA com uma cena competitiva estabelecida. A Riot
            Games organiza o "League of Legends World Championship", um torneio anual que atrai milhões de espectadores
            ...
            pOutro MOBA popular é "Dota 2", desenvolvido pela Valve Corporation. O jogo tem sua própria competição de
            eSports, o "The International", que é conhecido por ter premiações astronômicas. Os jogadores profissionais
            de Dota 2 competem por prêmios em dinheiro que chegam a milhões de dólares.</p>

            <h2>Dados de jogos MOBA:</h2>
            <p>Os jogos MOBA atraem uma base de fãs enorme e têm uma presença significativa nos eSports. Aqui estão alguns
...
<br>
           <p>Os jogos MOBA são conhecidos por sua complexidade estratégica, ampla variedade de personagens jogáveis e a
            necessidade de uma forte coordenação em equipe.

            Além dos jogos MOBA clássicos, existem também variações do gênero, como "Arena of Valor", "Mobile Legends" e
    ...
    <aside>
        <nav>
            <a href="https://overwatch.blizzard.com/pt-br/"
                target="_blank">
