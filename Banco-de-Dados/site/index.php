...
<body>
	<header>
		...
		<nav id="menu">
			...
			<a href="RTS.html" id="linkmenu">RTS</a>
			<a href="FPS.html" id="linkmenu">FPS</a>
			<a href="Luta.html" id="linkmenu">Luta</a>
			<a href="esportes.html" id="linkmenu">Esportes</a>
			<a href="cartas.html" id="linkmenu">Cartas</a>
			<a href="MOBA.html" id="linkmenu">MOBA</a>
		</nav>
	</header>
	<main>
		<section>
			...
			<a href="RTS.html">
				...
				<p class="section">Estratégia em Tempo Real: Os eSports de estratégia em tempo real?</p>
			</a>
			...
			<a href="FPS.html">
				...
				<p class="section">FPS: A modalidade mais conhecida de eSports!</p>
			</a>
			...
			<a href="Luta.html">
				...
				<p class="section">Luta: Conheça a modalidade eSports mais agressiva!</p>
			</a>
			...
			<a href="esportes.html">
				...
				<p class="section">Esportes: Esportes comuns mas dentro de telas!</p>
			</a>
			...
			<a href="cartas.html">
				...
				<p class="section">Cartas: Um esporte que exige muita atenção!</p>
			</a>
			...
			<a href="moba.html">
				...
				<p class="section">MOBA: Um jogo de estratégia em equipe!</p>
			</a>
		</section>
	</main>
	<aside>
	...
	<footer>
		<div id="footer_content">
			...
			<ul class="footer-list">
				...
				<li>
					<a href="jogo/jogo.html" class="footer-link">Jogue um jogo feito por mim</a>
				</li>
				<li>
